...
pub(crate) fn aes128_key_schedule(key: &[u8; 16]) -> FixsliceKeys128 {
    #[cfg(feature = "zeroize")]
    let mut rkeys = crate::howy_zeroize::Guard::new([0u32; 88]);
...
pub(crate) fn aes192_key_schedule(key: &[u8; 24]) -> FixsliceKeys192 {
    #[cfg(feature = "zeroize")]
    let mut rkeys = crate::howy_zeroize::Guard::new([0u32; 104]);
    #[cfg(not(feature = "zeroize"))]
    let mut rkeys = [0u32; 104];
    #[cfg(feature = "zeroize")]
    let mut tmp = crate::howy_zeroize::Guard::new([0u32; 8]);
    #[cfg(not(feature = "zeroize"))]
    let mut tmp = [0u32; 8];
...
pub(crate) fn aes256_key_schedule(key: &[u8; 32]) -> FixsliceKeys256 {
    #[cfg(feature = "zeroize")]
    let mut rkeys = crate::howy_zeroize::Guard::new([0u32; 120]);
    #[cfg(not(feature = "zeroize"))]
