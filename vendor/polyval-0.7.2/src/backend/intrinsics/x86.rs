...
pub(super) unsafe fn expand_key(h: &[u8; 16]) -> ExpandedKey {
    ...
    #[cfg(feature = "zeroize")]
    {
        ...
        expanded.h1 = FieldElement::from_m128i(h1);
        expanded.d1 = FieldElement::from_m128i(d1);
        expanded.h2 = FieldElement::from_m128i(h2);
        expanded.d2 = FieldElement::from_m128i(d2);
        expanded.h3 = FieldElement::from_m128i(h3);
        expanded.d3 = FieldElement::from_m128i(d3);
        expanded.h4 = FieldElement::from_m128i(h4);
        expanded.d4 = FieldElement::from_m128i(d4);
        expanded.take()
    }
    #[cfg(not(feature = "zeroize"))]
    ExpandedKey {
